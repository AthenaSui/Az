...
('70107','zhCN','|cff9900cc死灵法师|r$b|cffdd6600-=致敬魔兽争霸III/暗黑破坏神II=-|r$B$B\\\"受到的法术伤害降低20%，部分免疫控制效果，布甲，造成暗影法术伤害，无物理攻击，法术能量加成：100%智力。主要属性：智力。$B$B王者复生。从一具尸体上召唤2个骷髅（最多6个骷髅，65秒持续时间，仅对人型，野兽和龙类生物有效）。$B$B邪恶狂热。使目标近战攻击速度提高75%，但持续消耗生命值。持续45秒。无法取消。等级30解锁。$B$B邪爆。使一具尸体爆炸，对周围所有敌人造成相当于死亡单位最大生命值35%至75%的伤害（取决于死灵法师的等级）。该伤害不会产生威胁值。等级40解锁。$B$B残废。使目标移动速度，近战攻击速度和力量降低50%，持续60秒。等级50解锁。$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70108','zhCN','|cff0000dd女海巫|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"这些身上披着鳞甲的大海之女往往被人们看成是暴风雨即将来临的象征\\\".$B$B受到的法术伤害降低20%，部分免疫控制效果，布甲，造成物理/冰霜/风暴法术伤害，攻击强度加成：敏捷x2，法术强度加成：200%智力。主要属性：智力。$B$B叉状闪电。对施法者正面锥形区域内的敌人造成自然伤害。命中2个至全部目标（取决于女海巫的等级），并使其昏迷2秒。该伤害不会产生威胁值。$B$B冰霜箭。给箭矢注入冰霜法术并造成额外伤害，使目标的移动、攻击和施法速度降低30%到70%（取决于女海巫的等级）。$B$B法力护盾。制造一个护盾，消耗法力值吸收100%（未减免）伤害。效果范围每吸收一点伤害消耗10点法力值到每吸收10点伤害消耗1点法力值。（取决于女海巫等级）$B$B龙卷风。召唤一道龙卷风攻击附近的敌人并使其减速，有时会使其完全丧失能力。在室外龙卷风会随时间推移而增长，提高伤害和攻击范围，但在室内会缩小并快速消失。等级60解锁。$B$B纳迦（被动）。在水中时，游泳速度、伤害和躲闪几率大幅增加。$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70109','zhCN','|cff9900cc地穴领主|r$b|cffdd6600-=Warcraft III tribute=-|r$B$B\\\"古老的巨兽，曾是艾卓-尼鲁布的君王之一，现在是巫妖王手下最强大不死怪物战士\\\".$B$B非常高的护甲，增加的抗性，部分免疫控制效果，免疫中毒效果，锁甲/板甲，造成近战/暗影法术伤害，法术能量加成：200%力量。主要属性：力量。$B$B穿刺。地穴领主用他巨大的爪子猛击地面，在正前面锥形区域射出一排尖刺，对目标造成伤害并将其抛向空中，使其眩晕。解锁等级20。$B$B尖刺外壳。地穴领主的甲壳增加了抵抗伤害，并使近战攻击者造成15%到50%的反伤。$B$B腐尸甲虫。地穴领主从敌人的新鲜尸体中召唤一只腐尸甲虫来攻击他的敌人。腐尸甲虫永久存在但不会恢复生命，一次智能控制6只。更高的等级允许地穴领主召唤更强大的甲虫。解锁等级10级。$B$BLocust Swarm. 地穴领主制造一群20-40（取决于地穴领主的等级）愤怒的蝗虫，攻击附近的敌人，并降低目标的移动和攻击能力。蝗虫将对敌人造成伤害转化为生命值储存在自身，当它们返回时为地穴领主恢复生命值。解锁等级40级。$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
