...
bool Acore::Hyperlinks::LinkTags::item::StoreTo(ItemLinkData& val, std::string_view text)
{
    ...
    {
//        if (!val.Item->RandomSuffix) // <- mod_suffix
//            return false; // <- mod_suffix
    ...
    {
//        if (!val.Item->RandomProperty) // <- mod_suffix
//            return false; // <- mod_suffix
...
//    if ((val.RandomSuffix && !val.RandomSuffixBaseAmount) || (val.RandomSuffixBaseAmount && !val.RandomSuffix)) // <- mod_suffix
//        return false; // <- mod_suffix
