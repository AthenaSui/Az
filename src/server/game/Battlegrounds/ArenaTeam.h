...
public:
    ...
    void SetEmblem(uint32 backgroundColor, uint8 emblemStyle, uint32 emblemColor, uint8 borderStyle, uint32 borderColor);//<-playerbot
    void SetRatingForAll(uint32 rating);//<-playerbot
