...
public:
    ...
    static ReputationRank GetFactionReactionTo(FactionTemplateEntry const* factionTemplateEntry, FactionTemplateEntry const* targetFactionTemplateEntry);//<-playerbot
    ...
    void SendPlaySpellVisual(ObjectGuid guid, uint32 id);//<-playerbot
    ...
    */
    ...
    void SetCannotReachTargetUnit(bool target, bool isChase);//<-playerbot
    [[nodiscard]] bool CanNotReachTarget() const;//<-playerbot

    bool m_cannotReachTarget;//<-playerbot
