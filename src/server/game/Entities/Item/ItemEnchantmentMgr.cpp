...
uint32 GenerateEnchSuffixFactor(uint32 item_id)
{
    ...
    if (!itemProto)
        return 0;
// Disable this check to enable generating suffix factor for ALL items // <- mod_suffix
//    if (!itemProto->RandomSuffix)// <- mod_suffix
//        return 0;// <- mod_suffix
...
//        case INVTYPE_RELIC:// <- mod_suffix
    ...
    {
        case ITEM_QUALITY_NORMAL:// <- mod_suffix
            return randomProperty->UncommonPropertiesPoints[suffixFactor];// <- mod_suffix
        ...
        case ITEM_QUALITY_LEGENDARY:
            return randomProperty->EpicPropertiesPoints[suffixFactor];// <- mod_suffix
