...
int main(int argc, char** argv)
{
    ...
    sMetric->Initialize(realm.Name, *ioContext, []()
    {
        ...
        sScriptMgr->OnMetricLogging();//<-playerbot
    });
...
void StopDB()
{
    ...
    sScriptMgr->OnDatabasesClosing();//<-playerbot
...
void WorldUpdateLoop()
{
    ...
    sScriptMgr->OnDatabaseWarnAboutSyncQueries(true);//<-playerbot
    ...
    sScriptMgr->OnDatabaseWarnAboutSyncQueries(false);//<-playerbot
